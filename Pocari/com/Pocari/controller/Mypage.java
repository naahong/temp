		...
		switch(whatpage){
			case "restaurant":
				...
				if(tablename!=null && keyword!=null){
					mfl_totalpage = dao.getTotalPage("my_favlist");
					favlistV = dao.getMyfavlistSearch(keyword,pageidx);
					url = "mypage.jsp?sectionis=restaurant&pageidx="+pageidx;
					req.setAttribute("keyword", keyword);
				}else{
					mfl_totalpage = dao.getTotalPage("my_favlist");
					favlistV = dao.getMyfavlist(pageidx);
					url = "mypage.jsp?sectionis=restaurant&pageidx="+pageidx;
				}
			...
			case "recipe":
				int re_totalpage = dao.getTotalPage("recipe");
				Vector<RecipeBean> myrecipeV = dao.getMyRecipes(pageidx);
			...
			case "review":
				int rv_totalpage = dao.getTotalPage("my_review");
				Vector<FavlistAndReviewBean> myreviewsV = dao.getMyReviews(pageidx);
			...
			case "likerecipe":
				int lire_totalpage = dao.getTotalPage("save_recipe","like");
				Vector<RecipeBean> likeRecipeV = dao.getOtherRecipes("like",pageidx);
			...
			case "scraprecipe":
				int scre_totalpage = dao.getTotalPage("save_recipe","scrap");
				Vector<RecipeBean> scrapRecipeV = dao.getOtherRecipes("scrap",pageidx);
			...
			case "savestore":
				...
				if(tablename!=null && keyword!=null){
					ss_totalpage = dao.getTotalPage("save_store");
					savestoreV = dao.getSaveStorelistSearch(keyword,pageidx);
					url = "mypage.jsp?sectionis=savestore&pageidx="+pageidx;
					req.setAttribute("keyword", keyword);
				}else{
					ss_totalpage = dao.getTotalPage("save_store");
					savestoreV = dao.getSaveStorelist(pageidx);
					url = "mypage.jsp?sectionis=savestore&pageidx="+pageidx;
				}
