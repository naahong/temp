...
public class My_favlistDao extends DbcpCon {
	int result = 0;
   ...
   public int getMflIdx(int midx, String storename, String sido1, String gugun1){
	...
	public int getRIdx(int midx, int mfl_idx, String date){
    	...
    	String sql = "select review_idx from my_review where midx=? and mfl_idx=? and date=?";
	...
	public int getDRIdx(String comment) {
		int rres = 0;
		
		String sql = "select review_idx from my_review where comment='"+comment+"'";
